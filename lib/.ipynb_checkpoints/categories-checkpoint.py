...
CLASS_NAME = {
    ...
    'dataset1_classes': ['apple', 'avocado', 'capsicum', 'mango', 'orange', 'rockmelon', 'strawberry'],
    'dataset2_classes': ['car'],
    'dataset3_classes': ['dent', 'scratch', 'crack', 'glass shatter', 'lamp broken', 'tire flat']
}
